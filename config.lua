...
Config.WeaponDamage = {
    ...
    {Name = 'WEAPON_MELEE_HATCHET_HUNTER', Damage = 1.5},
    {Name = 'WEAPON_MELEE_KNIFE', Damage = 1.5},
    {Name = 'WEAPON_MELEE_KNIFE_HORROR', Damage = 1.5},
    {Name = 'WEAPON_MELEE_KNIFE_JAWBONE', Damage = 1.5},
    {Name = 'WEAPON_MELEE_KNIFE_RUSTIC', Damage = 1.5},
    {Name = 'WEAPON_MELEE_KNIFE_TRADER', Damage = 1.5},
    {Name = 'WEAPON_MELEE_MACHETE', Damage = 1.5},
    {Name = 'WEAPON_MELEE_MACHETE_COLLECTOR', Damage = 1.5},
    ...
    {Name = 'WEAPON_PISTOL_MAUSER', Damage = 1.9},
    {Name = 'WEAPON_PISTOL_SEMIAUTO', Damage = 1.85},
    ...
    --[[ {Name = 'WEAPON_THROWN_MOLOTOV', Damage = 1.5}, ]] -- Has no effect

    -- Shotgun
    {Name = 'WEAPON_SHOTGUN_DOUBLEBARREL', Damage = 1.5},
    {Name = 'WEAPON_SHOTGUN_PUMP', Damage = 1.5},
    {Name = 'WEAPON_SHOTGUN_REPEATING', Damage = 1.5},
    {Name = 'WEAPON_SHOTGUN_SAWEDOFF', Damage = 1.5},
